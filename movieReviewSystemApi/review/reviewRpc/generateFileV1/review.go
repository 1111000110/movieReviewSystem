...
import (
	...
	"movieReviewSystem/movieReviewSystemApi/review/reviewRpc/generateFileV1/internal/server"
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		__.RegisterReviewServiceServer(grpcServer, server.NewReviewServiceServer(ctx))
