...
func GroupUserHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GroupUserIdReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := group.NewGroupUserLogic(r.Context(), svcCtx)
		resp, err := l.GroupUser(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
